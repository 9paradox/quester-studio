...
| 18 | [UI — focus + control state](./18-ui-focus-and-states.md) | UI/UX review wave — **complete** |
| 19 | [UI — form labelling](./19-ui-form-labelling.md) | After 18 — **complete** |
| 20 | [UI — design system](./20-ui-design-system.md) | After 19 — **complete** |
| 21 | [UI — render perf](./21-ui-render-perf.md) | After 20 — **complete**; retired one plan-17 line item |
